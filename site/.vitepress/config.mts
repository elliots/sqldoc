    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '@history', link: '/namespaces/history' },
          { text: '@lint', link: '/namespaces/lint' },
          { text: '@postgraphile', link: '/namespaces/postgraphile' },
          { text: '@rls', link: '/namespaces/rls' },
          { text: '@softdelete', link: '/namespaces/softdelete' },
          { text: '@temporal', link: '/namespaces/temporal' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'PHP Eloquent', link: '/templates/php-eloquent' },
          { text: 'Ruby ActiveRecord', link: '/templates/ruby-activerecord' },
          { text: 'Swift Codable', link: '/templates/swift-codable' },
