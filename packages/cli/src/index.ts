...
program
  ...
  .option('--include-externals', 'Include @external files in output (excluded by default)')
...
schema
  ...
  .option('--schema <name>', 'Database schema to inspect (default: public for postgres)')
  .option('--project <name>', 'Select a named project from multi-project config')
...
schema
  ...
  .option('--from-schema <name>', 'Database schema to inspect on --from side (default: public for postgres)')
  .option('--to-schema <name>', 'Database schema to inspect on --to side (default: public for postgres)')
  .option('-c, --config <path>', 'Path to sqldoc.config.ts')
